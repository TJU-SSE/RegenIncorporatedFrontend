  ...
  <div class="send-twitter">
    <div class="bottom">
      ...
      <div class="btns">
        ...
        >
        <el-button type="primary" size="small">{{ dialogImageUrl ? '更换' : '添加' }}视频</el-button>
        </el-upload>
    <p>Tips：请将上传结束后产生的链接 复制到Video Link里哦~</p>
    <p>{{this.imgEle}}</p>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleSuccess (response, file, fileList) {
      ...
      this.imgEle = '视频的链接:' + this.dialogImageUrl
      this.$message({
        message: '图片上传成功~',
        type: 'success'
      })
